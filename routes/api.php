...
Route::group(['middleware' => ['guest', 'cors'], 'namespace' => 'Api', 'prefix' => 'post'], function() {
...
Route::group(['middleware' => ['guest', 'cors'], 'namespace' => 'Api', 'prefix' => 'company'], function() {
    Route::get('', 'CompanyController@getAll')->name('get.company.list');
    Route::get('{id}', 'CompanyController@getById')->name('get.company');
});

Route::group(['middleware' => ['guest', 'cors'], 'namespace' => 'Api', 'prefix' => 'category'], function() {
